...
class Config(object):
    ...
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "Denver")
    # Get the values for following 2 from my.telegram.org
    APP_ID = int(os.environ.get("APP_ID", 2945319))
    API_HASH = os.environ.get("API_HASH", b2e2b2f08331f3de995629be0f4e077a) or None
